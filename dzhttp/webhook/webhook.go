...
var _ dzhttp.PostAction = (*WebHook)(nil)
...
type Transform func(input *dzhttp.PostActionInput, args *Input) error
...
func (w *WebHook) Run(input *dzhttp.PostActionInput) error {
