...
var (
	_ dzstd.Builder[*HTTPMock, *HTTPMockApp] = (*mockBuilderFromFile)(nil)
	_ dzstd.Builder[*HTTPMock, *HTTPMockApp] = (*mockBuilderFromBytes)(nil)
...
func FromFile(filename string) dzstd.Builder[*HTTPMock, *HTTPMockApp] {
...
func FromBytes(b []byte, extension string) dzstd.Builder[*HTTPMock, *HTTPMockApp] {
...
func buildMockFromBytes(app *HTTPMockApp, builder *HTTPMockBuilder, content []byte, ext string) (*HTTPMock, error) {
	...
	if vi.IsSet(_fDelay) {
		...
		builder.Delay(dzstd.Latency(duration))
	}
