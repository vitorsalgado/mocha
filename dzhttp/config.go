...
// Parameters sets a custom reply parameters store.
func (cb *ConfigBuilder) Parameters(params dzstd.Params) *ConfigBuilder {
...
func (cb *ConfigBuilder) TemplateEngine(te dzstd.TemplateEngine) *ConfigBuilder {
