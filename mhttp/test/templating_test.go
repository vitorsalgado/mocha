...
func TestTemplating(t *testing.T) {
	...
	m.MustMock(mhttp2.FromFile("testdata/templating/templating_01.yaml"))
...
func TestTemplating_BodyFilename(t *testing.T) {
	...
	m.MustMock(mhttp2.FromFile("testdata/templating/templating_02.yaml"))
...
func TestTemplating_BodyFilename_BodyTemplate(t *testing.T) {
	...
	m.MustMock(mhttp2.FromFile("testdata/templating/templating_03.yaml"))
...
func TestTemplating_Header(t *testing.T) {
	...
	m.MustMock(mhttp2.FromFile("testdata/templating/templating_04.yaml"))
...
func TestTemplating_All(t *testing.T) {
	...
	m.Parameters().MustSet("test", "ok")
	m.Parameters().MustSet("context", "test")
	m.MustMock(mhttp2.FromFile("testdata/templating/templating_05.yaml"))
